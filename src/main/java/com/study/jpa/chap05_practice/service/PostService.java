...
public class PostService {
    ...
    public PostDetailResponseDTO getDetail(Long id) throws Exception { // 호출한 곳으로 예외 던짐
    ...
    public PostDetailResponseDTO insert(PostCreateDTO dto) {
        ...
        // dto -> entity로 바꿔 save의 인자로 넘겨주기 (서비스에서 말고 클래스에서 변환해주자)
    ...
    public PostDetailResponseDTO modify(postModifyDTO dto) {
        ...
        // 수정 완료
        Post modifiePost = postRepository.save(postEntity);

        return new PostDetailResponseDTO(modifiePost);
    }
